...
public class TimeStampDissectorTest {
  ...
  public class TestRecord {
    ...
    @Field({
            ...
            "TIME.MINUTE:request.receive.time.minute_gmt",
  ...
  public void testTimeStampDissector() throws Exception {
    ...
    assertEquals("0", results.get("TIME.MINUTE:request.receive.time.minute_gmt"));
    assertEquals(new Long(0), longResults.get("TIME.MINUTE:request.receive.time.minute_gmt"));
