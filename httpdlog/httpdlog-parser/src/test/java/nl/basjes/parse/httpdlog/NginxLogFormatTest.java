...
//            .printPossible()
    ...
    public void validateAllFields() {
        ...
        fieldsTests.add(new SingleFieldTestcase("$arg_name"                , "-"                                  , "IGNORED:ignored" /* FIXME */    , null                                   ));
        ...
        fieldsTests.add(new SingleFieldTestcase("$body_bytes_sent"         , "436"                                , "IGNORED:ignored" /* FIXME */    , "436"                                 ));
        fieldsTests.add(new SingleFieldTestcase("$bytes_sent"              , "694"                                , "BYTES:response.body.bytes" /* FIXME */    , "694"                                 ));
        fieldsTests.add(new SingleFieldTestcase("$connection"              , "5"                                  , "IGNORED:ignored" /* FIXME */    , "5"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$connection_requests"     , "4"                                  , "IGNORED:ignored" /* FIXME */    , "4"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$content_length"          , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$content_type"            , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$cookie_name"             , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        ...
        fieldsTests.add(new SingleFieldTestcase("$http_name"               , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        ...
        fieldsTests.add(new SingleFieldTestcase("$remote_addr"             , "127.0.0.1"                          , "IGNORED:ignored" /* FIXME */    , "127.0.0.1"                           ));
        fieldsTests.add(new SingleFieldTestcase("$remote_port"             , "44448"                              , "IGNORED:ignored" /* FIXME */    , "44448"                               ));
        fieldsTests.add(new SingleFieldTestcase("$remote_user"             , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$request"                 , "GET /?aap&noot=&mies=wim HTTP/1.1"  , "IGNORED:ignored" /* FIXME */    , "GET /?aap&noot=&mies=wim HTTP/1.1"   ));
        fieldsTests.add(new SingleFieldTestcase("$request_body"            , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$request_body_file"       , "-"                                  , "IGNORED:ignored" /* FIXME */    , "-"                                   ));
        ...
        fieldsTests.add(new SingleFieldTestcase("$scheme"                  , "http"                               , "IGNORED:ignored" /* FIXME */    , "http"                                ));
        fieldsTests.add(new SingleFieldTestcase("$sent_http_etag"          , "W/\\x22586bbb8b-29e\\x22"           , "IGNORED:ignored" /* FIXME */    , "W/\\x22586bbb8b-29e\\x22"            ));
        fieldsTests.add(new SingleFieldTestcase("$sent_http_last_modified" , "Tue, 03 Jan 2017 14:56:11 GMT"      , "IGNORED:ignored" /* FIXME */    , "Tue, 03 Jan 2017 14:56:11 GMT"       ));
        fieldsTests.add(new SingleFieldTestcase("$server_addr"             , "127.0.0.1"                          , "IGNORED:ignored" /* FIXME */    , "127.0.0.1"                           ));
        fieldsTests.add(new SingleFieldTestcase("$server_name"             , "_"                                  , "IGNORED:ignored" /* FIXME */    , "_"                                   ));
        fieldsTests.add(new SingleFieldTestcase("$server_port"             , "80"                                 , "IGNORED:ignored" /* FIXME */    , "80"                                  ));
        ...
        fieldsTests.add(new SingleFieldTestcase("$http_user_agent"         , "Mozilla/5.0 (Foo)"                  , "IGNORED:ignored" /* FIXME */    , "Mozilla/5.0 (Foo)"                   ));
        fieldsTests.add(new SingleFieldTestcase("$http_referer"            , "http://localhost/"                  , "IGNORED:ignored" /* FIXME */    , "http://localhost/"                   ));
