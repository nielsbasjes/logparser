...
public class VariousModule implements NginxModule {
    ...
    public List<TokenParser> getTokenParsers() {
        ...
        parsers.add(new TokenParser("$secure_link", PREFIX + ".secure_link.status", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $secure_link_expires
        ...
        // $session_log_id
        // current session ID;
        parsers.add(new TokenParser("$session_log_id", PREFIX + ".session_log.id", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$slice_range", PREFIX + ".slice_range", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$proxy_host", PREFIX + ".proxy.host", "STRING", Casts.STRING_ONLY, FORMAT_NO_SPACE_STRING));
        // $proxy_port
        // port of a proxied server as specified in the proxy_pass directive, or the protocol’s default port;
        parsers.add(new TokenParser("$proxy_port", PREFIX + ".proxy.port", "STRING", Casts.STRING_ONLY, FORMAT_NO_SPACE_STRING));
        ...
        parsers.add(new TokenParser("$proxy_add_x_forwarded_for",
            PREFIX + ".proxy.add_x_forwarded_for", "STRING", Casts.STRING_ONLY, FORMAT_NO_SPACE_STRING));
        ...
        parsers.add(new TokenParser("$uid_got", PREFIX + ".userid.uid_got", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $uid_reset
        ...
        parsers.add(new TokenParser("$uid_reset", PREFIX + ".userid.uid_reset", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $uid_set
        // The cookie name and sent client identifier.
        parsers.add(new TokenParser("$uid_set", PREFIX + ".userid.uid_set", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$modern_browser", PREFIX + ".browser.modern", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $ancient_browser
        // equals the value set by the ancient_browser_value directive, if a browser was identified as ancient;
        parsers.add(new TokenParser("$ancient_browser", PREFIX + ".browser.ancient", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $msie
        // equals “1” if a browser was identified as MSIE of any version.
        parsers.add(new TokenParser("$msie", PREFIX + ".browser.msie", "STRING", Casts.STRING_ONLY, FORMAT_NO_SPACE_STRING));
        ...
        parsers.add(new TokenParser("$connections_active", PREFIX + ".stub_status.connections.active", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $connections_reading
        // The current number of connections where nginx is reading the request header.
        parsers.add(new TokenParser("$connections_reading", PREFIX + ".stub_status.connections.reading", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $connections_writing
        // The current number of connections where nginx is writing the response back to the client.
        parsers.add(new TokenParser("$connections_writing", PREFIX + ".stub_status.connections.writing", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $connections_waiting
        // The current number of idle client connections waiting for a request.
        parsers.add(new TokenParser("$connections_waiting", PREFIX + ".stub_status.connections.waiting", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$date_local", PREFIX + ".date.local", "STRING", Casts.STRING_ONLY, FORMAT_STRING));

        // $date_gmt
        // current time in GMT. The format is set by the config command with the timefmt parameter.
        parsers.add(new TokenParser("$date_gmt", PREFIX + ".date.gmt", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$fastcgi_script_name", PREFIX + ".fastcgi.script_name", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$fastcgi_path_info", PREFIX + ".fastcgi.path_info", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$gzip_ratio", PREFIX + ".gzip.ratio", "STRING", Casts.STRING_ONLY, FORMAT_NUMBER_OPTIONAL_DECIMAL));
        ...
        parsers.add(new TokenParser("$spdy", PREFIX + ".spdy.version", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        // $spdy_request_priority
        // request priority for SPDY connections, or an empty string otherwise.
        parsers.add(new TokenParser("$spdy_request_priority", PREFIX + ".spdy.request_priority", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$http2", PREFIX + ".http2.negotiated_protocol", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$invalid_referer", PREFIX + ".referer.invalid", "STRING", Casts.STRING_ONLY, "1?"));
        ...
        parsers.add(new TokenParser("$memcached_key", PREFIX + ".memcached.key", "STRING", Casts.STRING_ONLY, FORMAT_STRING));
        ...
        parsers.add(new TokenParser("$realip_remote_addr", PREFIX + ".realip.remote_addr", "IP", Casts.STRING_ONLY, FORMAT_STRING));

        // $realip_remote_port
        // keeps the original client port
        parsers.add(new TokenParser("$realip_remote_port", PREFIX + ".realip.remote_port", "PORT", Casts.STRING_OR_LONG, FORMAT_STRING));
