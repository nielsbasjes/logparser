...
//            .verbose()
    ...
    public void runDoubleDissectors(){
        DissectorTester.create()
            ...
            .expect("INT:something.fooint",           (Double) null)
            ...
            .expect("FLOAT:something.foofloat",       (Long)null)
            ...
            .expect("INT:something.barint",           (Double) null)
            ...
            .expect("FLOAT:something.barfloat",       (Long)null)
